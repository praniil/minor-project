        ...
        <>
            <div className="h-3/4 w-[60%] rounded-xl bg-slate-800 flex">
                ...
                <div className="h-full w-full rounded-md cursor-pointer">
                    <form onSubmit={handleSubmit} className=" h-full flex flex-col items-center gap-5 p-14">
                        <div className="text-3xl text-white">CREATE AN ACCOUNT</div>
                        <div className="text-white">Already exists ? Log in</div>

                        <div className="w-full flex justify-center gap-5">
                            <input type="text" className="p-5 rounded-md h-10 outline-none" value={firstName} onChange={handleTypeChange} placeholder='First name' />
                            <input type="text" className="p-5 rounded-md h-10 outline-none" placeholder="Last name" />
                        </div>

                        <input type="email" className="p-5 w-full rounded-md h-10 outline-none" placeholder="Email" />
                        <input type="password" className="p-5 w-full rounded-md h-10 outline-none" placeholder="Password" />
